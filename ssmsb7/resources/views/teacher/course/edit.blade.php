                ...
                <div class="card-body">
                    ...
                    <form action="{{route('course.update',['id'=>$course->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="starting_date" value="{{$course->starting_date}}" class="form-control" id="horizontal-email-input">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="fee" value="{{$course->fee}}" class="form-control" id="horizontal-email-input">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="duration" value="{{$course->duration}}" class="form-control" id="horizontal-email-input">
                            </div>
                        </div>
